...
let count = document.querySelector(".questionNumber")

    let numberQuestion = 1
    count.innerText = numberQuestion + "/10"

    titleQuestion.innerText = questions[0].question
      let answer = []
      answer.push(questions[0].correct_answer)
      let arr = questions[0].incorrect_answers
